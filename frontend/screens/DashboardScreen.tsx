...
export default function DashboardScreen({ userName = 'Zeeshan' }) {
  ...
  return (
    <LinearGradient colors={['#121212', '#1E1E1E']} style={styles.container}>
      ...
      <View style={styles.bottomNav}>
        <FontAwesome5 name="home" size={22} color="#F3F3F3" />
        <Ionicons name="alert-circle-outline" size={22} color="#B5B5B5" />
        <Ionicons name="analytics-outline" size={22} color="#B5B5B5" />
...
const styles = StyleSheet.create({
  ...
  headerText: {
    color: '#F3F3F3', fontSize: 20, fontFamily: 'Poppins',
  },
  ...
  iconLabel: {
    color: '#B5B5B5', fontSize: 12, marginTop: 8, fontFamily: 'Poppins',
  },
  ...
  bottomNav: {
    position: 'absolute', bottom: 0, height: 70, backgroundColor: '#1E1E1E',
    width: '100%', flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center',
    borderTopColor: '#2B2B2B', borderTopWidth: 1,
  },
});
